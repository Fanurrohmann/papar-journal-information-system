...
class EditorAdvertisementController extends Controller
{
    public function home_ad_show()
    {
        $home_ad_data = HomeAdvertisement::where('id', 1)->first();
        return view('editor.advertisement_home_view', compact('home_ad_data'));
    }
    ...
    public function home_ad_update(Request $request)
    {
        ...
        if ($request->hasFile('above_search_ad')) {
            ...
            $old_file = public_path('uploads/' . $home_ad_data->above_search_ad);
        ...
        if ($request->hasFile('above_footer_ad')) {
            ...
            $old_file = public_path('uploads/' . $home_ad_data->above_footer_ad);
            if (file_exists($old_file)) {
                unlink($old_file);
            }
    ...
    public function top_ad_show()
    {
        ...
        return view('editor.advertisement_top_view', compact('top_ad_data'));
    }
    ...
    public function top_ad_update(Request $request)
    {
        ...
        if ($request->hasFile('top_ad')) {
            ...
            $old_file = public_path('uploads/' . $top_ad_data->top_ad);
            if (file_exists($old_file)) {
                unlink($old_file);
            }
    ...
    public function sidebar_ad_show()
    {
        ...
        return view('editor.advertisement_sidebar_view', compact('sidebar_ad_data'));
    }

    public function sidebar_ad_create()
    {
        return view('editor.advertisement_sidebar_create');
    }
    ...
    public function sidebar_ad_store(Request $request)
    {
        ...
        return redirect()->route('editor_sidebar_ad_show')->with('success', 'Data is created successfully');
    }

    public function sidebar_ad_edit($id)
    {
        $sidebar_ad_data = SidebarAdvertisement::where('id', $id)->first();
        return view('editor.advertisement_sidebar_edit', compact('sidebar_ad_data'));
    }
    ...
    public function sidebar_ad_update(Request $request, $id)
    {
        ...
        if ($request->hasFile('sidebar_ad')) {
            ...
            $old_file = public_path('uploads/' . $sidebar_ad_data->sidebar_ad);
            if (file_exists($old_file)) {
                unlink($old_file);
            }
        ...
        return redirect()->route('editor_sidebar_ad_show')->with('success', 'Data is updated successfully');
    }
    ...
    public function sidebar_ad_delete($id)
    {
        ...
        return redirect()->route('editor_sidebar_ad_show')->with('success', 'Data is deleted successfully');
    }
}
