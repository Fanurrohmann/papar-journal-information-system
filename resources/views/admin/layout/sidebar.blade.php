<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('admin/editor*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.editor.index') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Kelola Editor">
                    <i class="fas fa-user-cog"></i> <span>Kelola Editor</span>
                </a>
            </li>
            ...
            <li class="nav-item dropdown {{ Request::is('admin/top-advertisement')||Request::is('admin/home-advertisement')||Request::is('admin/sidebar-advertisement-*') ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('admin/top-advertisement') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_top_ad_show') }}"><i class="fas fa-angle-right"></i> Top Advertisements</a></li>
                    <li class="{{ Request::is('admin/home-advertisement') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_home_ad_show') }}"><i class="fas fa-angle-right"></i> Home Advertisements</a></li>
                    <li class="{{ Request::is('admin/sidebar-advertisement-*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_sidebar_ad_show') }}"><i class="fas fa-angle-right"></i> Sidebar Advertisements</a></li>
                </ul>
            </li>
            ...
            <li class="nav-item dropdown {{ Request::is('admin/page/*') ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Request::is('admin/page/terms') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_page_terms') }}"><i class="fas fa-angle-right"></i> Terms and Condition</a></li>
            ...
            <li class="nav-item dropdown {{ Request::is('admin/subscriber/*') ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Request::is('admin/subscriber/send-email/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_subscribers_send_email') }}"><i class="fas fa-angle-right"></i> Send Email to All</a></li>
                </ul>
            </li>
            ...
            <li class="{{ Request::is('admin/online-poll/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_online_poll_show') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Online Poll"><i class="fas fa-poll"></i> <span>Online Poll</span></a></li>
